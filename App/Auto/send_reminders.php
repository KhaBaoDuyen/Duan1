...
foreach ($reminders as $reminder) {
    ...
    try {
      ...
      <body class="p-5">
        ...
        $mail->addEmbeddedImage($_SERVER['DOCUMENT_ROOT'] . 'D:\hoctap\hocki4\BLOCK2\MONDUAN\WebBanCayCanhVaHoa\public\assets\Client\image\main\image-removebg-preview.png', 'tree_image');
        $emailTemplate = str_replace('D:\hoctap\hocki4\BLOCK2\MONDUAN\WebBanCayCanhVaHoa\public\assets\Client\image\main\image-removebg-preview.png', 'cid:tree_image', $emailTemplate);
