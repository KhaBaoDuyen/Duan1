        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action="/admin/comments/<?= $data['id_comments'] ?>" method="POST">
                                <div class="card-body">
                                    <h4 class="card-title">Sửa bình luận</h4>
                                    <input type="hidden" name="method" id="" value="PUT">
                                    <div class="form-group">
                                        <label for="id">ID</label>
                                        <input type="text" class="form-control" id="id" name="id" value="<?= $data['id_comments'] ?>" disabled>
                                    </div>
                                    <div class="form-group">
