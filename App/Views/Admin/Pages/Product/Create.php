                            ...
                            <form class="form-horizontal" action="/admin/products" method="POST" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="description" placeholder="Nhập mô tả sản phẩm..."
                                            name="description"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="discount_price">Giá giảm*</label>
                                        <input type="text" class="form-control" id="discount_price"
                                            placeholder="Nhập giá giảm sản phẩm..." name="discount_price">
                                    </div>
                                    <div class="form-group">
                                        <label for="categories_id">Danh mục*</label>
                                        <select class="select2 form-select shadow-none" id="categories_id" name="categories_id">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-select shadow-none" id="is_featured" name="is_featured">
                                            <option value="" selected disabled>Vui lòng chọn...</option>
