         ...
         <section class="sec_title row justify-content-between">
            <aside class="d-flex justify-content-between align-content-center col-6">
               <div class="click_slide col-2 m-1">
                  ...
                  <div class="box_image">
                     ...
                     foreach ($data['images_product'] as $image) { ?>
                        <img src="<?= APP_URL ?><?= $image['url'] ?>" width="100%" alt="Ảnh click"
               ...
               <div class="image col-10 m-1">
                  <img id="myImage" src="<?= APP_URL ?><?= $data['products']['image'] ?>" alt="Ảnh sản phẩm">
            ...
            <article class="col-6">
               ...
               <h3 class="name_product"><?= $data['products']['name'] ?></h3>
               <p class="describe"><?= $data['products']['short_description'] ?></p>

               <div class="price_product ">
                  <h5 class="price_old "><?= $data['products']['price'] ?></h5>
                  <h5 class="price_new"><?= $data['products']['discount_price'] ?></h5>
               </div>
               <form action="/add_to_card" method="get">
                  ...
                  <div class="box_count d-flex mt-3">
                     ...
                     <div class="box_count_btn d-flex">
                        ...
                        <input type="number" name="product_quantity" id="number" value="1" min="1" readonly>
                  ...
                  <div class="box_btn mt-3 d-flex">
                     ...
                     <input type="hidden" name="product_name" value="<?= $data['products']['name'] ?>">
               ...
               <div class="col-11">
                  <div class="user d-flex align-items-center">
                     ...
                     <div class="d-flex ">
                        ...
                        <span class="date"><?= $data['products']['date'] ?></span>
                     </div>
                  </div>
