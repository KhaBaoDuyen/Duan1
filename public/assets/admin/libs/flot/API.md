...
section. The time plugin (jquery.flot.time.js) is  for time
series support.
...
Please note that it is now  to include the time plugin,
...
hooks in the plugins bundled with Flot.
 ...
 - processRawData  [phase 3]
    ...
    ```js
    [
        { x: true, number: true, : true },
        { y: true, number: true, : true }
    ]
    ```
    ...
    If "" is true, then the value must exist (be non-null) for the
